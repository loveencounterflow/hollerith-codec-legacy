(function() {
  ...
  write_private = function(idx, value) {
    var proper_value, ref, type, wrapped_value;
  ...
  read_private = function(buffer, idx, private_handler) {
    var R, ref, ref1, type, value;
    idx += bytecount_typemarker;
    ref = read_list(buffer, idx), idx = ref[0], (ref1 = ref[1], type = ref1[0], value = ref1[1]);
    if (private_handler != null) {
      R = private_handler(type, value);
  ...
  write = function(idx, value) {
    ...
    if (CND.isa_pod(value)) {
      return write_private(idx, value);
    }
  ...
  this.decode = function(buffer, private_handler) {
    return (_decode(buffer, 0, false, private_handler))[1];
  };

  _decode = function(buffer, idx, single, private_handler) {
    ...
    while (true) {
      ...
      switch (type = buffer[idx]) {
        ...
        case tm_date:
          ...
          break;
        case tm_private:
          ref7 = read_private(buffer, idx, private_handler), idx = ref7[0], value = ref7[1];
          break;
        default:
