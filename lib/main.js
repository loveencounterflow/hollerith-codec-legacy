(function() {
  var CND, _decode, _encode, _invert_buffer, badge, bytecount_date, bytecount_number, bytecount_singular, debug, grow_rbuffer, last_unicode_chr, max_bytes_per_chr, rbuffer, rbuffer_delta_size, rbuffer_max_size, rbuffer_min_size, read_date, read_list, read_nnumber, read_pnumber, read_singular, read_text, release_extraneous_rbuffer_bytes, rpr, tm_date, tm_false, tm_hi, tm_list, tm_lo, tm_ninfinity, tm_nnumber, tm_null, tm_pinfinity, tm_pnumber, tm_text, tm_true, warn, write, write_date, write_infinity, write_number, write_singular, write_text;
