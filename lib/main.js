...
(function() {
    ...
    while (true) {
      ...
      switch (type = buffer[idx]) {
        ...
        case tm_nnumber:
          ...
          break;
        case tm_ninfinity:
          ref3 = [idx + 1, -2e308], idx = ref3[0], value = ref3[1];
          break;
        case tm_pnumber:
          ref4 = read_pnumber(buffer, idx), idx = ref4[0], value = ref4[1];
          break;
        case tm_pinfinity:
          ref5 = [idx + 1, +2e308], idx = ref5[0], value = ref5[1];
          break;
        case tm_date:
  ...
  this.as_sortline = function(key, settings) {
    var base, buffer, buffer_txt, idx, joiner, ref, ref1, ref2, stringify;
    ...
    buffer_txt = ((function() {
      var j, ref3, results;
      results = [];
      for (idx = j = 0, ref3 = buffer.length; 0 <= ref3 ? j < ref3 : j > ref3; idx = 0 <= ref3 ? ++j : --j) {
