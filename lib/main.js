(function() {
  ...
  read_list = function(buffer, idx) {
    ...
    while (true) {
      ...
      ref = _decode(buffer, idx, false), idx = ref[0], value = ref[1];
      R.push(value[0]);
      if (byte == null) {
